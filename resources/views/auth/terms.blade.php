...
<head>
      ...
      <!-- Typography CSS -->
      <link rel="stylesheet" href="user/css/typography.css">
      <!-- Style CSS -->
   ...
   <body class="sidebar-main-active right-column-fixed">
         ...
         <div class="iq-sidebar">
            <div class="iq-navbar-logo d-flex justify-content-between">
               <a href="index-2.html" class="header-logo">
                  <img src="user/images/logo.png" class="img-fluid rounded" alt="">
                  <span>FinDash</span>
               </a>
               ...
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav ml-auto navbar-list">
                        <li class="nav-item">
                           <a class="search-toggle iq-waves-effect language-title" href="#"><span class="ripple rippleEffect" style="width: 98px; height: 98px; top: -15px; left: 56.2969px;"></span><img src="user/images/small/flag-01.png" alt="img-flaf" class="img-fluid mr-1" style="height: 16px; width: 16px;"> EN <i class="ri-arrow-down-s-line"></i></a>
                           <div class="iq-sub-dropdown">
                              <a class="iq-sub-card" href="#"><img src="user/images/small/flag-02.png" alt="img-flaf" class="img-fluid mr-2">French</a>
                              <a class="iq-sub-card" href="#"><img src="user/images/small/flag-03.png" alt="img-flaf" class="img-fluid mr-2">Spanish</a>
                              <a class="iq-sub-card" href="#"><img src="user/images/small/flag-04.png" alt="img-flaf" class="img-fluid mr-2">Italian</a>
                              <a class="iq-sub-card" href="#"><img src="user/images/small/flag-05.png" alt="img-flaf" class="img-fluid mr-2">German</a>
                              <a class="iq-sub-card" href="#"><img src="user/images/small/flag-06.png" alt="img-flaf" class="img-fluid mr-2">Japanese</a>
                           </div>
                        </li>
                                 ...
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="user/images/user/01.jpg" alt="">
                                          </div>
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="user/images/user/02.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="user/images/user/03.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="user/images/user/04.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                              ...
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="user/images/user/05.jpg" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                  ...
                  <ul class="navbar-list">
                     <li class="line-height">
                        <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                           <img src="user/images/user/1.jpg" class="img-fluid rounded mr-3" alt="user">
                           <div class="caption">
      ...
      <script src="user/js/charts.js"></script>
      <!-- am animated JavaScript -->
      <script src="user/js/animated.js"></script>
      <!-- am kelly JavaScript -->
      <script src="user/js/kelly.js"></script>
      <!-- am maps JavaScript -->
      <script src="user/js/maps.js"></script>
      <!-- am worldLow JavaScript -->
      <script src="user/js/worldLow.js"></script>
      <!-- Style Customizer -->
